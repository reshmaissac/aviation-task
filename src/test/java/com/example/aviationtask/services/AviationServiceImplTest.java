...
public class AviationServiceImplTest {
	...
	public void testGetFlightDetailsByNumbAndDate() {
		...
		when(flightRepository.findByFlightNumberAndDepartureDate(flightNumber, departureDate)).thenReturn(flightEntity);
	...
	public void testGetAirportDetailsByIATACodeAndDate() {
		...
		// Execute the method
		AirportResponse airportResponse = aviationService.getAirportDetailsByIATACodeAndDate(airportCode,
				departureDate);
	...
	private FlightEntity createFlightEntity(Long id, int flightNumber, String departureAirportCode,
			String arrivalAirportCode, String departureDate) {
